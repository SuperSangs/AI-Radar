...
SOURCES = (
    ...
    Source("hf-models", "Hugging Face 模型", "global", "model", "https://huggingface.co/api/models?sort=trending&limit=40&full=true", "huggingface", 1.3),
    Source("hf-spaces", "Hugging Face Spaces", "global", "project", "https://huggingface.co/api/spaces?sort=trending&limit=30&full=true", "huggingface", 1.25),
    ...
    Source("reddit-ml", "Reddit MachineLearning", "global", "discussion", "https://www.reddit.com/r/MachineLearning/hot.json?limit=35&raw_json=1", "reddit", 0.95),
    Source("reddit-localllama", "Reddit LocalLLaMA", "global", "discussion", "https://www.reddit.com/r/LocalLLaMA/hot.json?limit=35&raw_json=1", "reddit", 1.0),
